...
public class MUSICMYlistgoodmanage중복 {
	...
	//	JButton b3 = new JButton("중복");
		...
		b4.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				ManagemusicUI manage = new ManagemusicUI();
				manage.open();
				f.setVisible(false);
...
//				
//				//3. 가방을 전달하자.
//				int result = dao.check(bag);
//				if(result == 1) {
//					JOptionPane.showMessageDialog(f, "음악중복");
//				}else {
//					JOptionPane.showMessageDialog(f, "음악 미중복, 재입력해주세요.");
//				}
//			}//action
//		}); //b3
//		
