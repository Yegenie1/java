...
public class 일기장쓰기 {
	...
	public void open() {
		...
		System.out.println("화면이 open될 거예요");
		...
		btn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println("오늘의 날짜 : " + day2);
				System.out.println("오늘의 제목 : " + title2);
				System.out.println("오늘의 내용 : " + content2);

				// 저장!! 파일도 만들어주고 자바프로그램과 file간에 연결통로(강물, stream)을 만들어 준다
				// 외부에 있는 파일, 네트워크나 cpu등을 자바에서 연결할 때는 아주 위험한 상황이라고 인식
				// 이렇게 위험한 상황에서 만약 문제가 발생하면 어떻게 처리할지 써줘야함 try-catch
